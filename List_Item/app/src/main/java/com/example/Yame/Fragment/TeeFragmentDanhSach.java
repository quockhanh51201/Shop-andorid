...
public class TeeFragmentDanhSach extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tee, container, false);


        recyclerView = (RecyclerView)view.findViewById(R.id.recyclerViewTee);
    ...
    private void getDataProduct2(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, Server.linkProductTee,null, new Response.Listener<JSONArray>() {
            @Override
