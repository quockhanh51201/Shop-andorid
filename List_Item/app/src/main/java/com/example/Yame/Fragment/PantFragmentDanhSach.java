...
public class PantFragmentDanhSach extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView)view.findViewById(R.id.recyclerViewPant);
    ...
    private void getDataProduct2(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, Server.linkProductPant,null, new Response.Listener<JSONArray>() {
            @Override
