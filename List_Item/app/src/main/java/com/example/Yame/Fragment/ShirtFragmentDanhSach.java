...
public class ShirtFragmentDanhSach extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView)view.findViewById(R.id.recyclerViewShirt);
    ...
    private void getDataProduct2(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, Server.linkProductShirt,null, new Response.Listener<JSONArray>() {
            @Override
